...
const Header = ({type}) => {
    ...
    const handleSearch = ()=>{
        navigate("./hotels",{state:{desitination, options, date}})
    };
        ...
        <div className="header">
            <div className={type==="list"?"headerContainer listMode":"headerContainer"}>
                <div className="headerList">
                    ...
                    <div className="headerListItem">
                        <FontAwesomeIcon icon={faLandmark} /><span>Attractions</span>
                    </div>
                    <div className="headerListItem">
                ...
                <p className="headerDesc">Sign up for our loyalty program to receive exclusive discounts and benefits with willbooking!</p>
